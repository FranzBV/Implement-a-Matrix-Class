...
class Matrix(object):
        ...
        if self.h == 1 and self.w == 1:
            ...
            for i in range(self.h):
                for j in range(self.w):
                    inverse[i][j] = adj[i][j] * (1/self.determinant())
            return inverse
            
    def adjugate(self):
        return [[self.g[1][1], -1 * self.g[0][1]], [-1 * self.g[1][0], self.g[0][0]]]
    ...
    def __add__(self,other):
        ...
        # TODO - your code here
        #
        a = zeroes(self.h, self.w)
        for r in range(self.h):
            for c in range(self.w):
                a[r][c] = (self.g[r][c] + other[r][c])
        return a
    ...
    def __sub__(self, other):
        ...
        for r in range(self.h):
            sRow = []
            for c in range(self.w):
                sRow.append(self.g[r][c] - other[r][c])
            s.append(sRow)
        return Matrix(s)
